...
func NewSecurityUser() SecurityUser {
	return &SecurityUserTest{}
}

func (su *SecurityUserTest) ParseFromContext(ctx context.Context) error {
...
func (su *SecurityUserTest) GetSubject() string {
	return su.AuthorityId
}

func (su *SecurityUserTest) GetObject() string {
	return su.Path
}

func (su *SecurityUserTest) GetAction() string {
	return su.Method
}

func (su *SecurityUserTest) GetDomain() string {
	return su.Domain
}
